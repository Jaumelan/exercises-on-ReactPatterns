export { default as RenderPropsPage } from "./BugPage";
export { default as ControlPropsPage } from "./ControlProps";
export { default as HOCPage } from "./HOCPage";
export { default as PropsGettersPage } from "./PropsGettersPage";
